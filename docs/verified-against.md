...
| 2026-09-12 | `@deepseek-ai/cordis@4.0.2`, `@deepseek-ai/schemastery@3.18.2` | CI `npm ci` + public registry; ffmpeg-free gif/mp4 fallback; workbench 设置页 / 画廊回填 / 10MB 上传上限. Offline suite **111/111** green. Live official-shell AC-UI-11/12 still unsigned. |
